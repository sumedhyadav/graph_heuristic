(function(e, t, n) {
...
})(
  {
      ...
      function(require, module, exports) {
        ...
        DataProjector = (function(_super) {
          ...
          DataProjector.prototype.onStorageEvent = function(type, data) {
            switch (type) {
              case Storage.EVENT_DATA_READY:
                this.info.display(
                  "Processed " + this.storage.getPoints() + " points."
                );
                this.info.display(
                  "Found " + this.storage.getClusters() + " target classes."
                );
                return this.initialize();
              case Storage.EVENT_SCREENSHOT_OK:
                return this.info.display(
                  "Screenshot " + this.storage.getSaved() + " saved."
                );
            }
          };
          ...
          DataProjector.prototype.onProjectorEvent = function(type, data) {
            console.log(
              "DataProjector.onProjectorEvent " + type + " : " + data
            );
            switch (type) {
          ...
          DataProjector.prototype.initialize = function() {
            ...
            this.menu.create(
              this.storage.getClusters(),
              this.palette.getColors()
            );
          ...
          Menu.prototype.create = function(clusters, colors) {
            ...
            for (
              ...
              html =
                ...
                i +
                "'> Cluster Center with target class ~</span><span class='color' id='c" +
                i +
                "'> " +
                i +
                " </span><br/>";
            ...
            for (
              ...
              // new
              edge_type_1_html = "<span style='color:#6a5acd;'> Edges of Graph Construction I type </span><br/>";
              $("#menu").append(edge_type_1_html);

              edge_type_2_html = "<span style='color:#3cb371;'> Edges of Graph Construction II type </span><br/>";
              $("#menu").append(edge_type_2_html);
          ...
          Menu.prototype.updateSwatches = function() {
            ...
            for (
              ...
              if (i === this.selected) {
                ...
                _results.push(
                  $("#c" + String(i)).css("color", this.colors[i].getStyle())
                );
              }
            }
            return _results;
    ...
    7: [
      function(require, module, exports) {
        ...
        Projector = (function(_super) {
          ...
          // =-=-
          Projector.prototype.neighbors = null;
          ...
          function Projector() {
            ...
            // =-=-
            // this.updateEdges = __bind(this.updateEdges, this);

            this.toggleClusterSelection = __bind(
              this.toggleClusterSelection,
              this
            );
            this.setAllClustersVisible = __bind(
              this.setAllClustersVisible,
              this
            );
            this.toggleClusterVisibility = __bind(
            ...
            // =-=-
            // this.processEdge = __bind(this.processEdge, this);

            this.load = __bind(this.load, this);
            this.createRenderingEngine = __bind(
            ...
            this.createOrthographicCamera = __bind(
              this.createOrthographicCamera,
              this
            );
            this.createPerspectiveCamera = __bind(
          ...
          Projector.prototype.onWindowResize = function(event) {
            ...
            console.log(
              "Screen " + this.SCREEN_WIDTH + " x " + this.SCREEN_HEIGHT
            );
            if (this.renderer != null) {
              this.renderer.setSize(this.SCREEN_WIDTH, this.SCREEN_HEIGHT);
              switch (this.mode) {
                case Projector.VIEW.PERSPECTIVE:
                  this.cameraPerspective.aspect =
                ...
                case Projector.VIEW.DUAL:
                  this.cameraPerspective.aspect =
                    (0.5 * this.SCREEN_WIDTH) / this.SCREEN_HEIGHT;
                  this.cameraPerspective.updateProjectionMatrix();
          ...
          Projector.prototype.load = function(storage) {
            ...
            // return instance of Storage.prototype.data
            data = this.storage.getData();
            clusters = this.storage.getClusters();
            this.points = new Array();
            for (
              c = _i = 0;
              0 <= clusters ? _i < clusters : _i > clusters;
              c = 0 <= clusters ? ++_i : --_i
            ) {
            ...
            // =-=- an instance for neighbors
            this.neighbors = new Array();
            $.each(data.points, this.processPoint);
            this.particles = new Array();
            for (
              p = _j = 0;
              0 <= clusters ? _j < clusters : _j > clusters;
              p = 0 <= clusters ? ++_j : --_j
            ) {
              ...
              // =-=- magic needs to happen after this
              this.particles[p] = new THREE.ParticleSystem(
                this.points[p],
                material
              );
            ...
            var material = new THREE.LineBasicMaterial({ color: '#3cb371', linewidth: 2, lights: true  });
            
            // line 1
            var line_geometry = new THREE.Geometry();
            line_geometry.vertices.push( this.points[0].vertices[0] );
            line_geometry.vertices.push( this.points[1].vertices[0] );
            var line = new THREE.Line( line_geometry, material );
            this.box.add(line);
            
            // line 2
            line_geometry = new THREE.Geometry();
            line_geometry.vertices.push( this.points[0].vertices[1] );
            line_geometry.vertices.push( this.points[1].vertices[1] );
            line = new THREE.Line( line_geometry, material );
            this.box.add(line);            

            // line 3 
            material = new THREE.LineBasicMaterial({ color: '#6a5acd', linewidth: 2, lights: true });
            line_geometry = new THREE.Geometry();
            line_geometry.vertices.push( this.points[0].vertices[2] );
            line_geometry.vertices.push( this.points[0].vertices[3] );
            line = new THREE.Line( line_geometry, material );
            this.box.add(line);

            // line 4
            line_geometry = new THREE.Geometry();
            line_geometry.vertices.push( this.points[1].vertices[3] );
            line_geometry.vertices.push( this.points[1].vertices[4] );
            line = new THREE.Line( line_geometry, material );
            this.box.add(line);            

            // var material = new THREE.LineBasicMaterial({ color: 0x00ff00 });
            // var material = new THREE.LineBasicMaterial({ color: 'green' });
            // var material = new THREE.LineBasicMaterial({ color: '#ff6347' });
            // line_geometry.vertices.push( this.points[0].vertices[1] );
          ...
          Projector.prototype.processPoint = function(nodeName, nodeData) {
            ...
            // parse neighbor list too
            node = parseInt(nodeData.id);
            firstNeigh = parseInt(nodeData.neighbors);

            this.neighbors.push([node, firstNeigh]);
          ...
          Projector.prototype.updateSelection = function() {
            ...
            counter = 0;
            for (
              i = _i = 0, _ref = this.storage.getClusters();
              0 <= _ref ? _i < _ref : _i > _ref;
              i = 0 <= _ref ? ++_i : --_i
            ) {
              if (this.particles[i].visible) {
                ...
                for (
                  ...
                  if (
                    ...
                    this.selector.contains(vertex, Utility.DIRECTION.ALL)
                  ) {
          ...
          Projector.prototype.updateMouse3D = function() {
            ...
            switch (this.direction) {
              case Utility.DIRECTION.TOP:
                this.mouse.x =
                  (event.pageX - (3 * this.SCREEN_WIDTH) / 4) * ratio;
                this.mouse.y = 100;
                return (this.mouse.z =
                  (event.pageY - this.SCREEN_HEIGHT / 2) * ratio);
          ...
          Projector.prototype.toggleClusterVisibility = function(index) {
            return (this.particles[index].visible = !this.particles[index]
              .visible);
          };
    ...
    8: [
        ...
        Selector = (function() {
          ...
          Selector.prototype.start = function(mouse) {
            ...
            if (!this.contains(mouse, this.direction)) {
              ...
              switch (this.direction) {
                case Utility.DIRECTION.TOP:
                  return (this.mouseStart = this.getStart(
                    mouse,
                    this.selectorTop
                  ));
                case Utility.DIRECTION.FRONT:
          ...
          Selector.prototype.updateBounds = function() {
            this.min.x = Math.min(
              this.getMinX(this.selectorTop),
              this.getMinX(this.selectorFront)
            );
            this.max.x = Math.max(
              this.getMaxX(this.selectorTop),
              this.getMaxX(this.selectorFront)
            );
            this.min.y = Math.min(
              this.getMinY(this.selectorFront),
              this.getMinY(this.selectorSide)
            );
            this.max.y = Math.max(
              this.getMaxY(this.selectorFront),
              this.getMaxY(this.selectorSide)
            );
            this.min.z = Math.min(
              this.getMinZ(this.selectorTop),
              this.getMinZ(this.selectorSide)
            );
            return (this.max.z = Math.max(
              this.getMaxZ(this.selectorTop),
              this.getMaxZ(this.selectorSide)
            ));
          };
          ...
          Selector.prototype.createSelector = function(direction) {
            ...
            return (selector = new THREE.Line(
              geometry,
              new THREE.LineBasicMaterial({
      ...
      { "./Palette.coffee": 5, "./Utility.coffee": 12 }
    ],
    9: [
      function(require, module, exports) {
        var Storage,
        ...
        Storage = (function(_super) {
          ...
          Storage.prototype.requestJSON = function(datafile) {
            ...
            this.datafile = datafile;
            file =
              this.datafile + "?" + String(Math.round(Math.random() * 99999));
          ...
          Storage.prototype.processPoint = function(nodeName, nodeData) {
            var _ref;
            if (
              ((_ref = nodeData.cid), __indexOf.call(this.clusterIDs, _ref) < 0)
            ) {
          ...
          // =-=- magic needs to happen after this
          // bascially read edges
          // Storage.prototype.getEdges = function() {
    ...
    11: [
      function(require, module, exports) {
        ...
        Toolbar = (function(_super) {
          ...
          function Toolbar(id) {
            this.setAnimateButtonSelected = __bind(
              this.setAnimateButtonSelected,
              this
            );
            this.setSpinButtonSelected = __bind(
              this.setSpinButtonSelected,
              this
            );
            this.setViewButtonSelected = __bind(
              this.setViewButtonSelected,
              this
            );
            this.setSelectButtonSelected = __bind(
              this.setSelectButtonSelected,
              this
            );
            this.setViewportButtonSelected = __bind(
              this.setViewportButtonSelected,
              this
            );
            ...
            this.setCameraButtonSelected = __bind(
              this.setCameraButtonSelected,
              this
            );
            this.setInfoButtonSelected = __bind(
              this.setInfoButtonSelected,
              this
            );
            this.setMenuButtonSelected = __bind(
              this.setMenuButtonSelected,
              this
            );
          ...
          Toolbar.prototype.setCameraButtonSelected = function(
            selected1,
            selected2,
            selected3
          ) {
          ...
          Toolbar.prototype.setViewButtonSelected = function(
            selected1,
            selected2,
            selected3
          ) {
          ...
          Toolbar.prototype.setSpinButtonSelected = function(
            selected1,
            selected2,
            selected3
          ) {
      ...
      { "./Palette.coffee": 5, "./Panel.coffee": 6, "./Utility.coffee": 12 }
    ],
    12: [
      function(require, module, exports) {
        var Utility;
